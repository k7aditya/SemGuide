          ...
          <Stack direction="column" spacing={1} alignItems="center">
            ...
            <Stack direction={{ xs: 'row', sm: 'row' }} spacing={1}>
              {/* <IconButton
                ...
                href=""
                aria-label="Facebook"
                sx={{ color: 'white', fontSize: '2rem' }} // Increase icon size
              >
                <svg
              ...
              {/* <FacebookIcon /> */}
              {/* {icon('ic_fb')} */}
              {/* <SvgColor src='/assets/icons/navbar/ic_fb.svg' sx={{ width: 1, height: 1 }} />
              {/* </IconButton> */}
              <IconButton
                color="inherit"
                href="https://twitter.com/Aditya_k1955"
                target="_blank"
                aria-label="Twitter"
                sx={{ color: 'white', fontSize: '2rem' }} // Increase icon size
              >
              ...
              <IconButton
                color="inherit"
                href="https://www.linkedin.com/in/k7aditya/"
                target="_blank"
                aria-label="LinkedIn"
                sx={{ color: 'white', fontSize: '2rem' }} // Increase icon size
              >
              ...
              <IconButton
                color="inherit"
                href="https://www.instagram.com/the_aditya_k_/"
                target="_blank"
